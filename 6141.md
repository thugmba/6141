...
## Development Environment and AI Error Protocol

All sessions use Google Antigravity IDE with four workspace panels: `[1] File Explorer`, `[2] Code Editor`, `[3] AI Agent Chat`, and `[4] Integrated Terminal`. When an error occurs, students identify the error type in Panel `[4]`, capture the traceback with `Windows Key + Shift + S` or `Command + Shift + 4`, paste it into Panel `[3]`, review the explanation, apply the verified fix in Panel `[2]`, and confirm an error-free execution with return code 0. Session 1.1 provides the complete orientation; every later lab applies the same workflow.

## Table of Contents

* **Module 1: Foundations of Business Analytics and Python Programming**
  * [Session 1.1: Business Analytics Architecture, Google Antigravity IDE Initialization, and Core Arithmetic](#session-01-01)
  * [Session 1.2: Essential Python Syntax Completion: Control Flow, Collections, and Business Automation](#session-01-02)
  * [Session 1.3: Tabular Data Wrangling Part 1: NumPy Arrays, Pandas DataFrames, and CSV Ingestion](#session-01-03)
  * [Session 1.4: Tabular Data Wrangling Part 2: Advanced Filtering, Multi-Segment GroupBy, and Financial Auditing](#session-01-04)
* **Module 2: Web Data Extraction, Visual Dashboards, and Midterm Milestone**
  * [Session 2.1: Web Data Extraction: Scraping Financial and Competitor Intelligence with Beautiful Soup](#session-02-01)
  * [Session 2.2: Business Data Visualization: Exploratory Plotting and Executive Dashboards](#session-02-02)
  * [Session 2.3: Midterm Applied Analytics Formulation Part 1: Problem Structuring and Data Audit](#session-02-03)
  * [Session 2.4: Midterm Analytics Pipeline Defense Part 2: Exploratory Findings and Executive Review](#session-02-04)
* **Module 3: Artificial Intelligence, Machine Learning Fundamentals, and Scikit-Learn**
  * [Session 3.1: Foundations of Artificial Intelligence: Enterprise Value Creation and Decision Automation](#session-03-01)
  * [Session 3.2: Advanced Data Analysis: Feature Engineering, Scaling, and Business Data Preprocessing](#session-03-02)
  * [Session 3.3: Practical Machine Learning with Scikit-Learn: Model Training and Validation](#session-03-03)
  * [Session 3.4: Core Concepts of Machine Learning: Supervised vs. Unsupervised Learning and Evaluation Metrics](#session-03-04)
* **Module 4: Strategic AI Integration, Enterprise Decision-Making, and AI Governance**
  * [Session 4.1: Integration of Business Analytics and Enterprise AI Architecture: End-to-End Decision Systems](#session-04-01)
  * [Session 4.2: AI Applications in Business Decision-Making Part 1: Predictive Customer Analytics and Churn](#session-04-02)
  * [Session 4.3: AI Applications in Business Decision-Making Part 2: Pricing Optimization and Revenue Management](#session-04-03)
  * [Session 4.4: Ethical Considerations in Artificial Intelligence: Algorithmic Bias, Regulatory Compliance, and AI Governance](#session-04-04)
...
<a id="session-01-01"></a>
### Session 1.1: Business Analytics Architecture, Google Antigravity IDE Initialization, and Core Arithmetic

![Session 1.1 Summary Slide](assets/session_01_01_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_01_01_lecture.pdf)
* **Schedule:** Week 1 (115/09/13 - 115/09/19) | In-person classes (1:2 Delivery Ratio: 60 Min Lecture + 120 Min Lab)
...
* **Lab Practice Dataset:**
  * File Link: [data/session_01_01_dataset.csv](data/session_01_01_dataset.csv)
...
* **Step-by-Step Lab Protocol (Exercise 1: Foundational Practice):**
  * *Step 1: Open Environment & Dataset:* Launch Google Antigravity IDE. Place `data/session_01_01_dataset.csv` in your working directory and open the raw file via Panel `[1]` (File Explorer) to observe comma-separated tabular records.
...
<a id="session-01-02"></a>
### Session 1.2: Essential Python Syntax Completion: Control Flow, Collections, and Business Automation

![Session 1.2 Summary Slide](assets/session_01_02_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_01_02_lecture.pdf)
...
* **Lab Practice Dataset:**
  * File Link: [data/session_01_02_dataset.csv](data/session_01_02_dataset.csv)
...
* **Step-by-Step Lab Protocol (Exercise 1: Guided Practice - Client Portfolio Automation):**
  ...
  * *Step 2: Build a Client Portfolio List:*
    Define an iterable list of customer dictionaries containing audited client records from `data/session_01_02_dataset.csv`:
    ```python
    clients = [
...
<a id="session-01-03"></a>
### Session 1.3: Tabular Data Wrangling Part 1: NumPy Arrays, Pandas DataFrames, and CSV Ingestion

![Session 1.3 Summary Slide](assets/session_01_03_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_01_03_lecture.pdf)
...
* **Hands-On Coding Micro-Examples:**
  * *Micro-Example 1 (Ingesting CSV and Inspecting Structure):*
    ...
    df = pd.read_csv("data/session_01_03_dataset.csv")
...
* **Lab Practice Dataset:**
  * File Link: [data/session_01_03_dataset.csv](data/session_01_03_dataset.csv)
...
* **Step-by-Step Lab Protocol (Exercise 1: Guided Practice - Retail Performance Wrangling):**
  * *Step 1: Open Workspace:* In Google Antigravity IDE, create a new script named `session_1_3_wrangling.py`. Verify that `data/session_01_03_dataset.csv` is present in Panel `[1]`.
...
<a id="session-01-04"></a>
### Session 1.4: Tabular Data Wrangling Part 2: Advanced Filtering, Multi-Segment GroupBy, and Financial Auditing

![Session 1.4 Summary Slide](assets/session_01_04_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_01_04_lecture.pdf)
...
* **Hands-On Coding Micro-Examples:**
  * *Micro-Example 1 (Multi-Condition Boolean Masking):*
    ...
    df = pd.read_csv("data/session_01_04_dataset.csv")
...
* **Lab Practice Dataset:**
  * File Link: [data/session_01_04_dataset.csv](data/session_01_04_dataset.csv)
...
<a id="session-02-01"></a>
### Session 2.1: Web Data Extraction: Scraping Financial and Competitor Intelligence with Beautiful Soup

![Session 2.1 Summary Slide](assets/session_02_01_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_02_01_lecture.pdf)
...
* **Lab Practice Dataset:**
  * File Link: [data/session_02_01_dataset.csv](data/session_02_01_dataset.csv)
...
* **Step-by-Step Lab Protocol (Exercise 1: Guided Practice - Competitor Price Scraper):**
  ...
  * *Step 2: Parse Competitor Pricing Markup:*
    ...
    df = pd.read_csv("data/session_02_01_dataset.csv")
...
<a id="session-02-02"></a>
### Session 2.2: Business Data Visualization: Exploratory Plotting and Executive Dashboards

![Session 2.2 Summary Slide](assets/session_02_02_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_02_02_lecture.pdf)
...
* **Hands-On Coding Micro-Examples:**
  * *Micro-Example 1 (Dual-Axis Time Series Plot):*
    ...
    df = pd.read_csv("data/session_02_02_dataset.csv")
...
* **Lab Practice Dataset:**
  * File Link: [data/session_02_02_dataset.csv](data/session_02_02_dataset.csv)
...
<a id="session-02-03"></a>
### Session 2.3: Midterm Applied Analytics Formulation Part 1: Problem Structuring and Data Audit

![Session 2.3 Summary Slide](assets/session_02_03_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_02_03_lecture.pdf)
...
* **Hands-On Coding Micro-Examples:**
  * *Micro-Example 1 (Automated Data Hygiene Scanner):*
    ...
    df = pd.read_csv("data/session_02_03_dataset.csv")
...
* **Lab Practice Dataset:**
  * File Link: [data/session_02_03_dataset.csv](data/session_02_03_dataset.csv)
...
<a id="session-02-04"></a>
### Session 2.4: Midterm Analytics Pipeline Defense Part 2: Exploratory Findings and Executive Review

![Session 2.4 Summary Slide](assets/session_02_04_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_02_04_lecture.pdf)
...
* **Hands-On Coding Micro-Examples:**
  * *Micro-Example 1 (Pipeline Execution Benchmark Timer):*
    ...
    df = pd.read_csv("data/session_02_04_dataset.csv")
...
* **Lab Practice Dataset:**
  * File Link: [data/session_02_04_dataset.csv](data/session_02_04_dataset.csv)
...
<a id="session-03-01"></a>
### Session 3.1: Foundations of Artificial Intelligence: Enterprise Value Creation and Decision Automation

![Session 3.1 Summary Slide](assets/session_03_01_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_03_01_lecture.pdf)
...
* **Hands-On Coding Micro-Examples:**
  * *Micro-Example 1 (AI Portfolio Investment Payback Calculator):*
    ...
    df = pd.read_csv("data/session_03_01_dataset.csv")
...
* **Lab Practice Dataset:**
  * File Link: [data/session_03_01_dataset.csv](data/session_03_01_dataset.csv)
...
<a id="session-03-02"></a>
### Session 3.2: Advanced Data Analysis: Feature Engineering, Scaling, and Business Data Preprocessing

![Session 3.2 Summary Slide](assets/session_03_02_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_03_02_lecture.pdf)
...
* **Hands-On Coding Micro-Examples:**
  * *Micro-Example 1 (Separating Feature Matrix X and Target Vector y):*
    ...
    df = pd.read_csv("data/session_03_02_dataset.csv")
...
* **Lab Practice Dataset:**
  * File Link: [data/session_03_02_dataset.csv](data/session_03_02_dataset.csv)
...
<a id="session-03-03"></a>
### Session 3.3: Practical Machine Learning with Scikit-Learn: Model Training and Validation

![Session 3.3 Summary Slide](assets/session_03_03_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_03_03_lecture.pdf)
...
* **Hands-On Coding Micro-Examples:**
  * *Micro-Example 1 (Training a Multi-Variable Linear Regression Model):*
    ...
    df = pd.read_csv("data/session_03_03_dataset.csv")
...
* **Lab Practice Dataset:**
  * File Link: [data/session_03_03_dataset.csv](data/session_03_03_dataset.csv)
...
<a id="session-03-04"></a>
### Session 3.4: Core Concepts of Machine Learning: Supervised vs. Unsupervised Learning and Evaluation Metrics

![Session 3.4 Summary Slide](assets/session_03_04_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_03_04_lecture.pdf)
...
* **Hands-On Coding Micro-Examples:**
  * *Micro-Example 1 (Confusion Matrix & Classification Report):*
    ...
    df = pd.read_csv("data/session_03_04_dataset.csv")
...
* **Lab Practice Dataset:**
  * File Link: [data/session_03_04_dataset.csv](data/session_03_04_dataset.csv)
...
<a id="session-04-01"></a>
### Session 4.1: Integration of Business Analytics and Enterprise AI Architecture: End-to-End Decision Systems

![Session 4.1 Summary Slide](assets/session_04_01_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_04_01_lecture.pdf)
...
* **Hands-On Coding Micro-Examples:**
  ...
  * *Micro-Example 2 (Automated Batch Inference Function):*
    ...
    df = pd.read_csv("data/session_04_01_dataset.csv")
...
* **Lab Practice Dataset:**
  * File Link: [data/session_04_01_dataset.csv](data/session_04_01_dataset.csv)
...
<a id="session-04-02"></a>
### Session 4.2: AI Applications in Business Decision-Making Part 1: Predictive Customer Analytics and Churn

![Session 4.2 Summary Slide](assets/session_04_02_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_04_02_lecture.pdf)
...
* **Hands-On Coding Micro-Examples:**
  * *Micro-Example 1 (Predicting Churn Probabilities with Logistic Regression):*
    ...
    df = pd.read_csv("data/session_04_02_dataset.csv")
...
* **Lab Practice Dataset:**
  * File Link: [data/session_04_02_dataset.csv](data/session_04_02_dataset.csv)
...
<a id="session-04-03"></a>
### Session 4.3: AI Applications in Business Decision-Making Part 2: Pricing Optimization and Revenue Management

![Session 4.3 Summary Slide](assets/session_04_03_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_04_03_lecture.pdf)
...
* **Hands-On Coding Micro-Examples:**
  * *Micro-Example 1 (Estimating Empirical Price Elasticity of Demand):*
    ...
    df = pd.read_csv("data/session_04_03_dataset.csv")
...
* **Lab Practice Dataset:**
  * File Link: [data/session_04_03_dataset.csv](data/session_04_03_dataset.csv)
...
<a id="session-04-04"></a>
### Session 4.4: Ethical Considerations in Artificial Intelligence: Algorithmic Bias, Regulatory Compliance, and AI Governance

![Session 4.4 Summary Slide](assets/session_04_04_slide.png)

* **Lecture Presentation:** [Download Slides (PDF)](slides/session_04_04_lecture.pdf)
...
* **Hands-On Coding Micro-Examples:**
  * *Micro-Example 1 (Calculating Disparate Impact Ratio):*
    ...
    df = pd.read_csv("data/session_04_04_dataset.csv")
...
* **Lab Practice Dataset:**
  * File Link: [data/session_04_04_dataset.csv](data/session_04_04_dataset.csv)
